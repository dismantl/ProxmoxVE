#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/dismantl/ProxmoxVE/main/misc/build.func)
# Copyright (c) 2025 Dan Staples
# Author: Dan Staples (dismantl)
# License: MIT | https://github.com/dismantl/ProxmoxVE/raw/main/LICENSE
# Source: 

APP="MediaServer"
var_tags="${var_tags:-mediaserver}"
var_cpu="${var_cpu:-4}"
